...
Explore the project through our multimedia resources:

*   **Explanatory Podcast:** Listen to an in-depth discussion about the project and its impacts. [AI Drones, Plant Doctors: How it Works (Audio)](Drones_IA_médicos_de_plantas__como_funciona.m4a)
*   **Project Video:** Watch a visual presentation of the system in action and its results. [Combating Sky Pests (Video)](Combater_Pragas_do_Céu.mp4)
